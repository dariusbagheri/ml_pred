...
window.particlesJS = function (tag_id, params) {
  ...
  var before = document.getElementById("particles-js-active");
  ...
  /* append canvas */
  var canvas = document.getElementById(tag_id).insertBefore(canvas_el, before);
...
window.particlesJSActive = function (tag_id, params) {
  //console.log(params);

  /* no string id? so it's object params, and set the id with default id */
  if (typeof tag_id != "string") {
    params = tag_id;
    tag_id = "particles-js-active";
  }
  ...
  var canvas_el = document.createElement("canvas");
  canvas_el.className = pJS_canvas_class;
  var before = document.getElementById("before_canvas");
